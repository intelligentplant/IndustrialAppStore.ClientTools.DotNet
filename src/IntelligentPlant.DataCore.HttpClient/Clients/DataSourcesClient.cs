...
namespace IntelligentPlant.DataCore.Client.Clients {
    ...
    public class DataSourcesClient<TContext, TOptions> : ClientBase<TOptions> where TOptions : DataCoreHttpClientOptions {
        ...
        /// <summary>
        /// Gets tags from the specified data source by ID or name.
        /// </summary>
        /// <param name="dsn">
        ///   The data source name.
        /// </param>
        /// <param name="request">
        ///   The request describing the tags to retrieve.
        /// </param>
        /// <param name="cancellationToken">
        ///   The cancellation token for the operation.
        /// </param>
        ...
        ///   The search results.
        /// </returns>
        public async Task<IEnumerable<TagSearchResult>> GetTagsByIdOrNameAsync(
