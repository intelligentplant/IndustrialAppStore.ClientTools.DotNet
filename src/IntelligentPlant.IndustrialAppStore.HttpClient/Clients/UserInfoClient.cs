...
namespace IntelligentPlant.IndustrialAppStore.Client.Clients {
    ...
    public class UserInfoClient<TContext> : IasClientBase {
        ...
        /// </exception>
        public UserInfoClient(HttpClient httpClient, IndustrialAppStoreHttpClientOptions options, JsonSerializerOptions jsonOptions)
        ...
        public async Task<UserOrGroupPrincipal> GetUserInfoAsync(
            ...
            using (var httpResponse = await HttpClient.SendAsync(httpRequest, cancellationToken).ConfigureAwait(false)) {
                return await ReadFromJsonAsync<UserOrGroupPrincipal>(httpResponse, cancellationToken).ConfigureAwait(false);
            }
        }
